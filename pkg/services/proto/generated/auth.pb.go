...
var file_auth_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x4a, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52,
	...
	0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5b, 0x0a, 0x11, 0x55, 0x73, 0x65,
	...
	0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x28, 0x0a, 0x0c, 0x50, 0x69, 0x6e, 0x67, 0x52, 0x65,
	...
	0x32, 0xdd, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x24, 0x0a, 0x04, 0x50, 0x69, 0x6e,
	...
	0x37, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x53, 0x69, 0x67, 0x6e, 0x55, 0x70, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x12, 0x11, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x53,
	0x69, 0x67, 0x6e, 0x49, 0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x11, 0x2e, 0x55, 0x73, 0x65,
	...
	0x65, 0x12, 0x3d, 0x0a, 0x12, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x41, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x13, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x55,
	...
	0x69, 0x67, 0x61, 0x6d, 0x6f, 0x6e, 0x6f, 0x2f, 0x67, 0x69, 0x67, 0x61, 0x6d, 0x6f, 0x6e, 0x6f,
...
var file_auth_proto_goTypes = []interface{}{
	...
	(*AccessTokenRequest)(nil), // 1: AccessTokenRequest
	(*UserTokenResponse)(nil),  // 2: UserTokenResponse
	(*PingResponse)(nil),       // 3: PingResponse
	(*Empty)(nil),              // 4: common.Empty
}
var file_auth_proto_depIdxs = []int32{
	4, // 0: Auth.Ping:input_type -> common.Empty
	0, // 1: Auth.GetSignUpToken:input_type -> UserTokenRequest
	0, // 2: Auth.GetSignInToken:input_type -> UserTokenRequest
	1, // 3: Auth.RefreshAccessToken:input_type -> AccessTokenRequest
	3, // 4: Auth.Ping:output_type -> PingResponse
	2, // 5: Auth.GetSignUpToken:output_type -> UserTokenResponse
	2, // 6: Auth.GetSignInToken:output_type -> UserTokenResponse
	2, // 7: Auth.RefreshAccessToken:output_type -> UserTokenResponse
...
func (c *authClient) GetSignUpToken(ctx context.Context, in *UserTokenRequest, opts ...grpc.CallOption) (*UserTokenResponse, error) {
	out := new(UserTokenResponse)
	err := c.cc.Invoke(ctx, "/Auth/GetSignUpToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) GetSignInToken(ctx context.Context, in *UserTokenRequest, opts ...grpc.CallOption) (*UserTokenResponse, error) {
	out := new(UserTokenResponse)
	err := c.cc.Invoke(ctx, "/Auth/GetSignInToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) RefreshAccessToken(ctx context.Context, in *AccessTokenRequest, opts ...grpc.CallOption) (*UserTokenResponse, error) {
	out := new(UserTokenResponse)
	err := c.cc.Invoke(ctx, "/Auth/RefreshAccessToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedAuthServer) GetSignUpToken(context.Context, *UserTokenRequest) (*UserTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSignUpToken not implemented")
}
func (*UnimplementedAuthServer) GetSignInToken(context.Context, *UserTokenRequest) (*UserTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSignInToken not implemented")
}
func (*UnimplementedAuthServer) RefreshAccessToken(context.Context, *AccessTokenRequest) (*UserTokenResponse, error) {
...
func _Auth_GetSignUpToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).GetSignUpToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Auth/GetSignUpToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetSignUpToken(ctx, req.(*UserTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Auth_GetSignInToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).GetSignInToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Auth/GetSignInToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetSignInToken(ctx, req.(*UserTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Auth_RefreshAccessToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Auth/RefreshAccessToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RefreshAccessToken(ctx, req.(*AccessTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Auth_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Auth_GetSignUpToken_Handler,
		},
		{
			MethodName: "GetSignInToken",
			Handler:    _Auth_GetSignInToken_Handler,
		},
		{
